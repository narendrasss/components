...
function Tree2Element(tree) {
  return tree && tree.map(function (node$$1, i) {
    return createElement(node$$1.tag, __assign({
      key: i
    }, node$$1.attr), Tree2Element(node$$1.child));
  });
}
...
export { Input, index as InputNumber, Radio, Form, Select };
